...
Slices 1-4 are implemented. Python and JavaScript run end to end locally; slice 4 still needs deploying to the mini-PC.
...
| [ ] | Slice 5 - Complete compiled-language support | Java, Haskell, C, C++ compile/run plus all native formatters, and a stdin field in the editor (the API already accepts it). C# is out of scope as of 2026-09-24 |
