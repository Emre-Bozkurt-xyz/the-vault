...
| `components/markdown/MarkdownEditor.tsx` | CodeMirror Markdown editor with live-mode-first UI, autosave, Markdown toolbar, Live-mode Properties/frontmatter controls, toolbar/paste/drop asset upload insertion, an in-editor `/` slash command menu, and optional Yjs collaboration |
